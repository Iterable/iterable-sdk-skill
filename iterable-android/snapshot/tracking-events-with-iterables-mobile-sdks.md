...
polished_at: 2026-08-03T23:37:53.318Z
layer: a
snippets:
  - index: 0
    lang: swift
  ...
  - index: 6
    ...
    hash: e3a8fdcd2031
    line_count: 33
summary: Iterable's mobile SDKs can track _events_, which correspond to actions
  taken by your app's users. Events can be related to messages you've sent (for
  example, a user opening an in-app message) or to a particular feature or piece
  of content in your app (for example, a user signing up for a new account).
---
